...
NotePad& NotePad::doSetTab(    NotePad& n, int v)
                                                  {n.getNote(SetTabNO).tab.set(v);       return n;}
NotePad& NotePad::doSetRTab(   NotePad& n, int v)
                                                  {n.getNote(SetTabNO).tab.set(v, true); return n;}
...
NotePad& NotePad::append(const CString& cs) {getNote(NmbrNO).line += cs;       return *this;}
