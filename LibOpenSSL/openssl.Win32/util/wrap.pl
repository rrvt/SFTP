...
BEGIN {
    ...
    require 'C:/Source2/LibOpenSSL/openssl.Win32/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = 'C:/Source2/LibOpenSSL/openssl.Win32/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = 'C:/Source2/LibOpenSSL/openssl.Win32/test/default-and-jitter.cnf';
    shift;
